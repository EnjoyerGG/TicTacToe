...
public class TicTacToe implements ActionListener {
    ...
    JPanel button_panel = new JPanel(); // hold all the buttons
    ...
    TicTacToe() {
        ...
        frame.add(title_panel, BorderLayout.NORTH); // set the title to the top of the frame
    ...
    public void firstTurn() {
        try {
            Thread.sleep(2000); // add the delay
